...
### 编辑调整 profile<a id="orgheadline5"></a>
...
\`cfs-edit-profile-without-ui' 适合有经验的用户使用，这个命令会打开当前 profile 文件，并激活内置的 profile 编辑模式，在编辑的过程中，用户可以使用下面三个命令 **快速** 的测试编辑效果：
